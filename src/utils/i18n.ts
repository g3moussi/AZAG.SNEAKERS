...
export const TRANSLATIONS: Record<Language, Translations> = {
  fr: {
    ...
    codModalSubtitle: 'Remplissez le formulaire ci-dessous. Votre commande sera immédiatement envoyée sur WhatsApp pour confirmation rapide.',
    ...
    confirmOrderBtn: 'Valider la Commande sur WhatsApp 📲',
    submittingOrder: 'Preparation de votre commande...',
    orderSuccessTitle: 'Commande Confirmée !',
    orderSuccessDesc: 'Merci pour votre confiance ! Votre commande a été enregistrée. Cliquez ci-dessous si WhatsApp ne s\'est pas ouvert automatiquement.',
    openWhatsAppBtn: 'Ouvrir WhatsApp pour confirmer',
    closeBtn: 'Fermer',
  ...
  ar: {
    ...
    codModalSubtitle: 'يرجى إدخال معلوماتك أدناه. سيتم إرسال تفاصيل طلبك مباشرة عبر الواتساب لتأكيد التوصيل فوراً.',
    ...
    confirmOrderBtn: 'تأكيد الطلب عبر الواتساب 📲',
    submittingOrder: 'جاري تجهيز طلبك...',
    orderSuccessTitle: 'تم تسجيل طلبك بنجاح!',
    orderSuccessDesc: 'شكراً لثقتكم بنا! اضغط على الزر أدناه لإرسال التفاصيل مباشرة عبر تطبيق الواتساب.',
    openWhatsAppBtn: 'فتح تطبيق الواتساب للتأكيد',
    closeBtn: 'إغلاق',
